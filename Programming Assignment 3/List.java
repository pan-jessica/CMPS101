...
public class List {
	...
	Object front() {	//Returns the front element. Precondition: length() > 0
		if (length > 0) {
			return front.data;
		}
		return -1;
	...
	Object back() {		//Returns the back element. Precondition: length() > 0
		if (length > 0) {
			return back.data;
		}
		return -1;
	...
	public boolean equals(Object x) {		
		...
		equal = true;
		while (equal && secondList != null) {
			equal = secondList.equals(firstList);			
	...
	//REMOVE copy() METHOD B/C IT'S IMPLEMENTED IN MATRIX.JAVA
	/*
	List copy() {
